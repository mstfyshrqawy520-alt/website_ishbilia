...
import { useStaggerReveal } from '@/lib/motion/useScrollAnimation';
...
export default function ServicesGrid() {
  ...
  useStaggerReveal(containerRef, '.stagger-child', 80);

  return (
    <section className="section-rhythm section-primary relative scroll-mt-28 w-full" id="services-section">
      <div className="section-container relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-ish-gray-light text-base sm:text-lg max-w-2xl mx-auto">
      ...
      {/* Smooth Bottom Gradient Transition to Next Section */}
      <div className="absolute bottom-0 left-0 right-0 h-28 bg-gradient-to-b from-transparent to-[var(--bg-secondary)]/40 pointer-events-none" />
    </section>
  );
}
